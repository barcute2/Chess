...
/**
 * This will test the basics of each piece
 * like the constructor and whether changing
 * the coordinates is working
 * @author zeno
 *
 */
public class AllPiecesTests {
	...
	public void testPawn(){
		...
		assertEquals("Must return 1", 1, pawn.legalMovePiece(3, 1));
		...
		assertEquals("Must return 0", 0, secondPawn.legalMovePiece(3, 3));
